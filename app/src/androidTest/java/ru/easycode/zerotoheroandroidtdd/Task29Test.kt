...
class Task29Test {
    ...
    fun create_folder_create_note() {
        ...
        createFolderPage.inputFolderName("first folder")
        ...
        createNotePage.inputNote(text = "note 1 in folder")
        ...
        folderDetailsPage.checkNote(position = 0, title = "note 1 in folder")
    ...
    fun create_folder_create_note_delete_folder() {
        ...
        createFolderPage.inputFolderName("new first folder")
